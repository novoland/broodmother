...
public class CrawlController implements ApplicationContextAware {
	 ...
	 * 每次请求{@link CrawlController#createCrawlPipeline()}通过
	 * {@link ApplicationContext#getBean(String)} 返回 Pipeline bean。
	 */
	private String crawlPipelineBeanId;
	...
	public Pipeline createCrawlPipeline() {
		return (Pipeline) appContext.getBean(crawlPipelineBeanId);
	}

	public String getCrawlPipelineId() {
		return crawlPipelineBeanId;
	}

	public void setCrawlPipelineBeanId(String beanId) {
		this.crawlPipelineBeanId = beanId;
	}
    ...
    public boolean stopped() {
        return Boolean.FALSE.equals(started);
    }
