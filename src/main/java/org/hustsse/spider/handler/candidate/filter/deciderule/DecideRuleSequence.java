 ...
 * {@link org.hustsse.spider.handler.candidate.filter.DecideResult#PASS}时才允许其通过，只要有一个Rule的结果是{@link org.hustsse.spider.handler.candidate.filter.DecideResult#REJECT}
